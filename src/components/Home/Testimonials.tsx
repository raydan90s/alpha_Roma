          ...
          <div className="space-y-8">
            <div className="border-l-4 border-primary pl-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                La satisfacción de nuestros clientes es nuestra mayor motivación. Descubre por qué tantas personas confían en nuestros servicios.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="space-y-6">
                ...
                <blockquote className="text-lg text-white leading-relaxed italic text-justify">
