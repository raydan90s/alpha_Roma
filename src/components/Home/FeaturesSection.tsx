...
const FeaturesSection: React.FC = () => {
  return (
    <section aria-label="Características de NexoLegal">
      <div className="py-20 bg-secondary relative overflow-hidden">
        {/* Fondo decorativo */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-10 w-32 h-32 bg-blue-500 rounded-full blur-2xl" />
          <div className="absolute bottom-20 right-10 w-40 h-40 bg-purple-500 rounded-full blur-2xl" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-lg">
                  Con 40 años de experiencia combinada, nuestro equipo de abogados expertos en
                  distintas áreas del derecho ha logrado resultados sobresalientes para nuestros
                  clientes. En NexoLegal, su éxito es nuestra prioridad.
                </p>
              </div>
              <button
            ...
            <div className="space-y-6">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:bg-gray-800/70 transition-all duration-300 transform hover:scale-105"
                >
                  <div className="flex items-start space-x-4">
                    <div
                      className={`flex-shrink-0 w-12 h-12 ${feature.bgColor} rounded-xl flex items-center justify-center`}
                    >
                      {feature.icon}
                    </div>
