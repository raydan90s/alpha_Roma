          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            ...
            <div className="bg-cardPrimary p-6 rounded-2xl mb-8 shadow-2xl">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[#E7EAED] text-sm">Precio único</p> {/* Acento en color claro */}
                  <p className="text-4xl font-bold text-white">$150</p> {/* Valor en blanco */}
                  <p className="text-[#E7EAED] text-sm">Sin importar número de socios</p> {/* Acento en color claro */}
                </div>
                <div className="text-right">
                  <p className="text-[#E7EAED] text-sm">Tiempo estimado</p> {/* Acento en color claro */}
                  <p className="text-2xl font-bold text-white">3-5 días</p> {/* Valor en blanco */}
                </div>
              </div>
            </div>
