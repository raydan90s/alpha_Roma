    ...
    <>
      ...
      <PreloaderWrapper imageUrls={imageUrls}>
        <div className="min-h-screen bg-gray-100">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-4 pt-4 border-t border-white/20">
                          ...
                          <div>
                            ...
                            {testimonialsData[currentIndex].company && <p className="text-gray-300 text-sm">{testimonialsData[currentIndex].company}</p>}
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          {/* Espacio inferior */}
          <section><div className="py-6"></div></section>
